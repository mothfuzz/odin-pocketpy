...
Additionally, for extremely simple structs (all numeric types, standard layout, field count <= 16), there is a simple `bindstruct` procedure which can write `__new__`, `__init__`, `__repr__`, and all getters and setters automagically.
